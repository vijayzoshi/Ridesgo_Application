...
public class FillStudentDetails extends AppCompatActivity {
   ...
   @RequiresApi(api = Build.VERSION_CODES.N)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fill_student_details);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(FillStudentDetails.this, "Enter Complete Details", Toast.LENGTH_LONG).show();
                }else{
...
*/
                    Intent intent = new Intent(FillStudentDetails.this, MainActivity.class);
