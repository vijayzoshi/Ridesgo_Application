                            ...
                            myRef.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if(data == null){
                                        ...
                                        map1.put("School Name", "");
                                        map1.put("Student Class","");
                                        map1.put("Student Name","");
                                        map1.put("Home Address","");
                                        map1.put("Checked in","");
                                        map1.put("Checked out","");
                                        ...
                                        map2.put("Driver photo","");
                                        map2.put("Driver DL","");
                                        map2.put("Driver Name","");
                                        map2.put("Driver exp","");
                                        map2.put("DRIVER ALLOTED","0");

                                        myRef.child("User").child(currentuser).child("DRIVER DETAILS").updateChildren(map2);

                                        HashMap<String,Object> map3 = new HashMap<>();

                                        map3.put("Starting Date", "");
                                        map3.put("Pack","3 Months");

                                        myRef.child("User").child(currentuser).child("SUBSCRIPTION").updateChildren(map3);
